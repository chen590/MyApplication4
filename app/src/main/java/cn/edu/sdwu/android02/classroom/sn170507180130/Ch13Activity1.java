...
public class Ch13Activity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        port.setText(sharedPreferences.getString("ip",""));
    }
    ...
    public void readRaw(View view) {
        ...
        InputeStream inputeStream = resources.openRawResource(R.raw.readme);
        try {
            int size=inputeStream.available();
    ...
    private void writeExternal(String content){
        ...
        File file=new File(Environment.getExternalStorageDirectory(),"abcde.text");//构造方法中，提供文件所在的目录名和文件名
        try{
            //使用createNewFile创建文件
            file.createNewFile();
